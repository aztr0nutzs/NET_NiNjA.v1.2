...
- index.html path: http://127.0.0.1:8787/ui/ninja_mobile.html
...
## Lifecycle
- onCreate/onResume/onPause behavior: start foreground service, probe server readiness, then load URL
- Reload/reset rules: retry probe for up to 150s; load URL after readiness or timeout
